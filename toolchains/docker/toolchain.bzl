...
DockerToolchainInfo = provider(
    ...
    fields = {
        ...
        "xz_path": "Path to the xz binary. This is used by build_tar.py when " +
                   "the Python lzma module is unavailable.",
    },
)
...
docker_toolchain = rule(
    ...
    attrs = {
        ...
        "xz_path": attr.string(
            doc = "Path to the xz binary. This is used by build_tar.py when " +
                  "the Python lzma module is unavailable.",
        ),
    },
)
